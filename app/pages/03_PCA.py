...
st.sidebar.caption("Reducción de dimensionalidad")
...
st.sidebar.write("4. Proyección PC1-PC2")
...
st.markdown(
    ...
    <div style="padding: 0.2rem 0 0.9rem;">
        ...
        <p style="margin: 0; max-width: 840px; font-size: 1.02rem; line-height: 1.6; color: #5d6b78;">
            Esta sección resume las variables numéricas principales y muestra cómo se distribuyen los usuarios en un espacio reducido.
        </p>
    </div>
    """,
...
with right:
    callout(
        "Por qué se escaló",
        "Las variables tienen unidades distintas: edad en años, consumo en minutos y soporte en tickets. Con Z-score se evita que los minutos dominen solo por tener números más grandes.",
        "Preparación",
    )
...
with st.container(border=True):
    ...
    st.caption(
        "La varianza explicada indica cuánta información resume cada componente. Si una componente explica poco, se interpreta con prudencia."
    )
...
fig2 = px.scatter(
    ...
    opacity=0.55,
    title="Proyección PC1-PC2 por plan",
    color_discrete_sequence=PALETTE,
)
